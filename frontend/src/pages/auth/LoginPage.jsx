...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-50 to-blue-100 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center p-4">
      <button onClick={toggle} className="absolute top-4 right-4 p-2 rounded-lg bg-white/80 dark:bg-gray-800/80 shadow">
      ...
      <div className="w-full max-w-md">
        <div className="card p-8 shadow-xl">
          ...
          <p className="mt-6 text-center text-xs text-gray-400">
            Default: <code className="bg-gray-100 dark:bg-gray-700 px-1.5 py-0.5 rounded">owner</code> / <code className="bg-gray-100 dark:bg-gray-700 px-1.5 py-0.5 rounded">Admin@123</code>
          </p>
        </div>
      </div>
    </div>
